    ...
    <section class="content">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">{{ __('words.edit_commission_level') }}</h3>
            </div>
            <div class="panel-body">
                <h3 style="color: red" class="text-center"> {{ __('words.commission_level_notice') }}</h3>
                <form class="form-horizontal" id="form" action="{{ route('yj_level.update', ['id' => $data->id]) }}" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="number" class="form-control" id="min" name="min" placeholder="例：1500" value="{{ $data->min }}"  />
                            </div>
                            <label for="max" class="col-sm-1 control-label">{{ __('words.maximum_amount') }}</label>
                            <div class="col-sm-3">
                                <input type="number" class="form-control" id="max" name="max" placeholder="例：1500" value="{{ $data->max }}"  />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="num" class="col-sm-2 control-label">{{ __('words.number_active_users') }}</label>
                            <div class="col-sm-7">
                                <input type="number" class="form-control" id="num" name="num" placeholder="例：20" value="{{ $data->num }}" />
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="box-footer">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                &nbsp;<a href="{{ route('yj_level.index') }}" class="btn btn-info">{{ __('words.reset') }}</a>
                            </div>
                        </div>
                    </div>
                </form>

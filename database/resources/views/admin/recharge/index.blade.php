            ...
            <table id="tab" class="table table-bordered table-hover text-center">
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <img class="pop" src="/uploads/{{ $item->receipt_image }}" height="150px" width="150px;">
                        <div class="modal fade" id="imagemodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                            ...
                            <div class="modal-body">
                                <img src="/uploads/{{ $item->receipt_image }}" id="imagepreview" style="width: 500px; height: 700px;" >
                            </div>
                ...
                @else
                <img src="/uploads/noimagefound.jpg" height="150px" width="150px;">
                @endif
            </td>
        </tr>
        @endforeach
...
<script>
    $(function(){
        ...
        $(".pop").on("click", function() {
           $(this).parent().find('#imagepreview').attr('src', $(this).parent().find('#imageresource').attr('src')); // here asign the image to the modal when the user click the enlarge link
           $(this).parent().find('#imagemodal').modal('show'); // imagemodal is the id attribute assigned to the bootstrap modal, then i use the show function
        });
    });
</script>
@endsection
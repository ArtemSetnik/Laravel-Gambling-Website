    ...
    <section class="content">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">{{__('words.game_record')}}</h3>
            </div>
            <div class="panel-body">
                ...
                <table class="table table-bordered table-hover text-center">
                    <tr>
                        <th style="width: 10%">{{__('words.note_number')}}</th>
                        <th style="width: 15%">{{__('words.account_number')}}</th>
                        {{--<th style="width: 15%">平台名称</th>--}}
                        <th style="width: 5%">{{__('words.platform_account')}}</th>
                        <th style="width: 5%">{{__('words.game_category')}}</th>
                        <th style="width: 5%">{{__('words.win_lose_situation')}}</th>
                        <th style="width: 5%">{{__('words.bet_amount')}}</th>
                        <th style="width: 5%">{{__('words.effective_bet')}}</th>

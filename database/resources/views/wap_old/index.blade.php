        ...
        <div class="m_body">
            ...
            <div class="m_wrapper clear">
                ...
                @if(in_array('MT', $_api_list))
                    <div class="m_box m_box-half">
                        <a class="m_box-link" onclick="javascript:window.open('{{ route('ng.playGame') }}?plat_type=MT&game_type=7&devices=1','','width=1024,height=768')">
                ...
                @if(in_array('VG', $_api_list))
                    <div class="m_box m_box-half">
                        <a class="m_box-link" onclick="javascript:window.open('{{ route('ng.playGame') }}?plat_type=VG&game_type=7&devices=1','','width=1024,height=768')">
                            {{--<img class="m_isComing" src="{{ asset('/wap/images/m_isComing.png') }}" alt="">--}}

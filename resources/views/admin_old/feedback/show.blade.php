                    ...
                    <form class="form-horizontal cmxform" name="registerForm" id="form" action="{{ route('drawing.confirm', ['id' => $data->getKey()]) }}" method="post">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="name"  placeholder="{{__('words.username')}}" value="{{ $data->member->name }}" required readonly />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="money" class="col-sm-2 control-label">{{__('words.Withdrawal_amount')}}</label>
                                <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="number" class="form-control" id="counter_fee" name="counter_fee" value="0" required />
                                </div>
                            </div>
                        </div><!-- /.box-body -->

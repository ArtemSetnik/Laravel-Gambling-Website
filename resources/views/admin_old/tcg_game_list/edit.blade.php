    ...
    <section class="content">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form class="form-horizontal" id="form" action="{{ route('tcg_game_list.update', ['id' => $data->id]) }}" method="post">
                    <input type="hidden" name="_method" value="put">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="productCode" class="col-sm-2 control-label">产品名称 <strong style="color: red">*</strong></label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="productCode" name="productCode" placeholder="例：PT" value="{{ $data->productCode }}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="gameType" class="col-sm-2 control-label">游戏类型 <strong style="color: red">*</strong></label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="gameType" name="gameType" placeholder="例：RNG" value="{{ $data->gameType }}" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="gameName" name="gameName" value="{{ $data->gameName }}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="tcgGameCode" class="col-sm-2 control-label">游戏代码 <strong style="color: red">*</strong></label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="tcgGameCode" name="tcgGameCode" value="{{ $data->tcgGameCode }}" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="platform" class="col-sm-2 control-label">支持的平台 <strong style="color: red">*</strong></label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="platform" name="platform" placeholder="例：flash,html5" value="{{ $data->platform }}" />
                            </div>
                        </div>
                        <div class="form-group">

    ...
    <section class="content">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">{{__('words.Edit_bank_card')}}</h3>
            </div>
                ...
                <form class="form-horizontal" id="form" action="{{ route('bank_card.update', ['id' => $data->id]) }}" method="post">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <label for="level" class="col-sm-2 control-label">{{__('words.Choose_account_bank')}} <strong style="color: red">*</strong></label>
                            <div class="col-sm-7">

...
<div class="m_container">
    <div class="m_body">
        ...
        <div class="m_notice">
			<span class="pull-left notice_logo"></span>
            ...
            <div class="">
    				...
    				<div class="pull-left notice_content" style="width:70%;">
                   ...
                   <!--  <div class="marquee3k pull-left notice_content"  style="width:70%;" 
                        data-speed="0.5">
        ...
        <div class="category-wrap-placeholder_3S0wB">
            <div class="category-wrap_d3wny"><div class="category-outer-inner_17KJ5">
             <div class="category-inner_ZydHv " style="width: 100%; height: 36px;">
				 <div class="category-name_2VWaa category-name-lottery_J-CBk current_2-Ch8"><a href="javascript:void(0)">{{ __('mb.Hot_Game') }}</a></div>
                 <div class="category-name_2VWaa category-name-casino_3hsqT"><a href="javascript:void(0)">{{ __('mb.video_live') }}</a></div>
  ...
  // 251 => "AG"
                  ...
                  <div class="m_box m_box-half">
                        <a class="m_box-link"  href="{{route('wap.hotgame',['type'=>'Joker'])}}">
                            <img src="{{ asset('/wap/images/100percent/Joker.png') }}" alt="">
                            <span class="m_box-name_new">
                              {{ __('mb.Joker') }}
                          </span>
                      </a>
                  ...
                  <div class="m_box m_box-half">
                        <a class="m_box-link"  href="{{route('wap.hotgame',['type'=>'Mega888'])}}">
                            <img src="{{ asset('/wap/images/100percent/Mega888.png') }}" alt="">
                            <span class="m_box-name_new">
                              {{ __('mb.Mega888') }}
                          </span>
                      </a>
                  ...
                  <div class="m_box m_box-half">
                        <a class="m_box-link"  href="{{route('wap.hotgame',['type'=>'Newtown'])}}">
                            <img src="{{ asset('/wap/images/100percent/Newtown.png') }}" alt="">
                            <span class="m_box-name_new">
                              {{ __('mb.Newtown') }}
                          </span>
                      </a>
                  ...
                  <div class="m_box m_box-half">
                        <a class="m_box-link"  href="{{route('wap.hotgame',['type'=>'Rollex'])}}">
                            <img src="{{ asset('/wap/images/100percent/Rollex.png') }}" alt="">
                            <span class="m_box-name_new">
                              {{ __('mb.Rollex') }}
                          </span>
                      </a>
